    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                ...
                <h1>IF YOU ARE A NEW USER PLEASE REGISTER</h1>
                ...
                <div class="col-md-12 text-left">
                    <a href="{{route('patient-register')}}"> <button  type="submit" value="submit" class="btn submit_btn">TAKE APPOINTMENT</button></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="department-slider owl-carousel">
                    ...
                    <div class="single-slide">
                        <div class="slide-img">
                            <img src="{{ asset('/') }}/front/images/department2.jpg" alt="" class="img-fluid">
                            <div class="hover-state">
                    ...
                    <div class="single-slide">
                        <div class="slide-img">
                            <img src="{{ asset('/') }}/front/images/department3.jpg" alt="" class="img-fluid">
                            <div class="hover-state">
                                <a href="departments.html"><i class="fa fa-stethoscope"></i></a>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="single-patient mb-4">
                    <img src="{{ asset('/') }}/front/images/patient1.png" alt="">
                    <h3>daren jhonson</h3>
                    <h5>hp specialist</h5>
                ...
                <div class="single-patient">
                    <img src="{{ asset('/') }}/front/images/patient2.png" alt="">
                    <h3>black heiden</h3>
                    <h5>hp specialist</h5>
                    <p class="pt-3">Elementum libero hac leo integer. Risus hac road parturient feugiat. Litora cursus hendrerit bib elit Tempus inceptos posuere metus.</p>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="single-doctor mb-4 mb-lg-0">
                    <div class="doctor-img">
                        <img src="{{ asset('/') }}/front/images/doctor1.jpg" alt="" class="img-fluid">
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-doctor mb-4 mb-lg-0">
                    <div class="doctor-img">
                        <img src="{{ asset('/') }}/front/images/doctor2.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="content-area">
                        <div class="doctor-name text-center">
                            <h3>dand mories</h3>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-doctor mb-4 mb-sm-0">
                    <div class="doctor-img">
                        <img src="{{ asset('/') }}/front/images/doctor3.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="content-area">
                        <div class="doctor-name text-center">
                            <h3>align board</h3>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-doctor">
                    <div class="doctor-img">
                        <img src="{{ asset('/') }}/front/images/doctor4.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="content-area">
                        <div class="doctor-name text-center">
                            <h3>jeson limit</h3>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-news">
                    <div class="news-img">
                        <img src="{{ asset('/') }}/front/images/news1.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="news-text">
                        <div class="news-date">
                            22 July 2018
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-news mt-5 mt-md-0">
                    <div class="news-img">
                        <img src="{{ asset('/') }}/front/images/news2.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="news-text">
                        <div class="news-date">
                            22 Oct 2018
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-news mt-5 mt-lg-0">
                    <div class="news-img">
                        <img src="{{ asset('/') }}/front/images/news3.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="news-text">
                        <div class="news-date">
                            22 Sep 2018
